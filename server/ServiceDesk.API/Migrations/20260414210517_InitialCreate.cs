        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    PublicNumber = table.Column<string>(type: "text", nullable: false),
                    ClientUserId = table.Column<string>(type: "text", nullable: false),
                    MasterUserId = table.Column<string>(type: "text", nullable: true),
                    DeviceTypeId = table.Column<int>(type: "integer", nullable: false),
                    ManufacturerId = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Tickets_AspNetUsers_MasterUserId",
                        column: x => x.MasterUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_Tickets_DeviceModels_DeviceModelId",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Tickets_Manufacturers_ManufacturerId",
                        column: x => x.ManufacturerId,
                        principalTable: "Manufacturers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FinancialTransactions_Tickets_TicketId",
                        column: x => x.TicketId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FinancialTransactions_PublicNumber",
                table: "FinancialTransactions",
                column: "PublicNumber",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_FinancialTransactions_TicketId",
                table: "FinancialTransactions",
                column: "TicketId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Tickets_ManufacturerId",
                table: "Tickets",
                column: "ManufacturerId");

            migrationBuilder.CreateIndex(
                name: "IX_Tickets_MasterUserId",
                table: "Tickets",
                column: "MasterUserId");

            migrationBuilder.CreateIndex(
                name: "IX_Tickets_PublicNumber",
                table: "Tickets",
                column: "PublicNumber",
                unique: true);
        }
